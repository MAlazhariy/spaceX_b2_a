...
class _NoInternetScreenState extends State<NoInternetScreen> {
  ...
  Widget build(BuildContext context) {
    final backgroundColor =
        widget.customOptions?.backgroundColor ?? Constants.disconnectionOptions.backgroundColor ?? Theme.of(context).colorScheme.error;
    ...
    final String title = widget.customOptions?.title ?? Constants.disconnectionOptions.title!;
    final String description = widget.customOptions?.description ?? Constants.disconnectionOptions.description!;
    final String tryAgain = widget.customOptions?.tryAgain ?? Constants.disconnectionOptions.tryAgain!;
      ...
      child: Container(
        ...
        child: Row(
          children: [
            ...
            Expanded(
              child: Text(
                Provider.of<InternetProvider>(context).connectionStatus == ConnectivityResult.none ? description : title,
